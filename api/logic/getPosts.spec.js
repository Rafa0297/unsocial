...
describe('getPosts', () => {
  ...
  it('succeeds for existing user', () => {
    ...
    const post2 = new Post({
      author: user.id,
      image: 'https://www.image.com/2',
      text: 'hello world 2',
      date: new Date(2024, 10, 19),
    })

    return Promise.all([user.save(), post.save(), post2.save()]).then(([user, post, post2]) =>
  ...
  it('fails on non-existing user', () =>
    expect(getPosts('012345678901234567890123')).to.be.rejectedWith(NotFoundError, /^user not found$/))
