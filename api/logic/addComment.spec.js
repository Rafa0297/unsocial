...
describe('addComment', () => {
  ...
  it('fails on non-existing user', () =>
    expect(addComment('012345678901234567890123', 'hello world', '012345678901234567890123')).to.be.rejectedWith(
      NotFoundError,
      /^user not found$/
    ))
  ...
  it('fails on non-exixting post', () =>
    expect(
      User.create({ name: 'Coco Loco', email: 'coco@loco.com', username: 'cocoloco', password: '123123123' }).then(
        (user) => addComment('012345678901234567890123', 'hello world', user.id)
      )
